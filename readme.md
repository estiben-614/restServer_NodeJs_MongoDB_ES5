...
Luego, realice peticiones a la siguiente URL  ```http://localhost:8000```

Para crear un usuario,  use una petición POST a la dirección ```http://localhost:8000/api/test``` con los siguientes datos en el body :                                                                                                       ``` {"nombre":"test1", 
                                                                              "google":true,
                                                                              "nuevoCampo":true,
...
Para ver todos los usuarios ingresados, use  las peticiones GET y que tienen los siguientes QUERY opcionales ```http://localhost:8000?desde=' '&limite= '   ' ```
